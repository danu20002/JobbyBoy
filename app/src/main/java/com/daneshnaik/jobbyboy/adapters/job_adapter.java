package com.daneshnaik.jobbyboy.adapters;
...
import com.daneshnaik.jobbyboy.activities.portal_link_opner;
...
public class job_adapter extends RecyclerView.Adapter<job_adapter.Viewport> {
    ...
    public job_adapter.Viewport onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.single_job_layout,parent,false);
